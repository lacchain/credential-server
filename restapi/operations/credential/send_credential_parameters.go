...
// NewSendCredentialParams creates a new SendCredentialParams object
// no default values defined in spec.
func NewSendCredentialParams() SendCredentialParams {

	return SendCredentialParams{}
}

// SendCredentialParams contains all the bound params for the send credential operation
